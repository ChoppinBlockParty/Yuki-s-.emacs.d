;;; pdf-config --- Evil bindings for pdf-tools
;;; Commentary:
...
(setq
  ...
  ;;; bottom edge of the page moves to the next page, and scrolling a
  ;;; line downward at the top edge of the page moves to the previous
  ;;; page.
  pdf-view-continuous t
  ;;; Fractional margin used for slicing with the bounding-box.
  pdf-view-bounding-box-margin 0.0
...
(evil-define-key 'normal pdf-view-mode-map
  ...
  (kbd "M-i") 'pdf-view-scroll-down-or-previous-page
  (kbd "M-u") 'pdf-view-scroll-up-or-next-page
...
(evil-define-key 'normal pdf-outline-buffer-mode-map
  ...
  (kbd "M-u") 'pdf-outline-select-pdf-window
...
(evil-define-key 'normal pdf-occur-buffer-mode-map
  ...
  (kbd "M-u") 'pdf-occur-view-occurrence
